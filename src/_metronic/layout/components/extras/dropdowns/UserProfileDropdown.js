...
export function UserProfileDropdown() {
    ...
    const resetDealer = async () => {
        try {
            await axios.post('set_dealer', {dealer_id: ''});
    ...
    const resetApplication = async () => {
        try {
            await axios.post('set_application', {application_id: ''});
            window.location.reload();
        } catch (e) {
        }
    }
                ...
                <div className="navi navi-spacer-x-0 pt-5">
                    <a href='#' onClick={(e) => {
                        ...
                        <div className="navi-link">
                            <div className="navi-icon mr-2">
                                <i className="flaticon2-refresh text-primary"/>
                            </div>
                            <div className="navi-text">
                                <div className="font-weight-bold">Change Dealer</div>
                                <div className="text-muted">Select another dealer from the list</div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href='#' onClick={(e) => {
                        ...
                        <div className="navi-link">
                            ...
                            <div className="navi-text">
                                <div className="font-weight-bold">Change Application</div>
                                <div className="text-muted">Select another application from the list</div>
                            </div>
                        </div>
                    </a>
                    <div className="navi-separator mt-3"/>
